...
/**
 * Definition class for table category.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_Category_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_Category_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_Category_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_Category_Rowset find()
 *
 */
abstract class Application_Model_Category_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
  ...
  0 => 'Application_Model_Post_DbTable',
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_Category_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_Category_Rowset';
