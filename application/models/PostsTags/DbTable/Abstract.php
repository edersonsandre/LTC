...
/**
 * Definition class for table posts_tags.
 *
 ...
 * @version $Id$
 *
 * @method Application_Model_PostsTags_Row createRow(array $data, string $defaultSource = null)
 * @method Application_Model_PostsTags_Rowset fetchAll(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $count = null, int $offset = null)
 * @method Application_Model_PostsTags_Row fetchRow(string|array|Zend_Db_Table_Select $where = null, string|array $order = null, int $offset = null)
 * @method Application_Model_PostsTags_Rowset find()
 *
 */
abstract class Application_Model_PostsTags_DbTable_Abstract extends Zend_Db_Table_Abstract
{
    /**
     * @var string
     */
  ...
  1 => 'tag_id',
    ...
    protected $_referenceMap = array(        
        'post_id' => array(
            'columns' => 'post_id',
            'refTableClass' => 'Application_Model_Post_DbTable',
            'refColumns' => 'id'
        ),

        'tag_id' => array(
            'columns' => 'tag_id',
            'refTableClass' => 'Application_Model_Tag_DbTable',
            'refColumns' => 'id'
        )
    );
     ...
     * @var string
     */
    protected $_rowClass = 'Application_Model_PostsTags_Row';

    /**
     * @var string
     */
    protected $_rowsetClass = 'Application_Model_PostsTags_Rowset';
  ...
  'tag_id' => NULL,
    ...
    public function getDbSelectByParams($params = array(), $sortField = '', $sortOrder = '')
    {
        ...
        if (isset($params['tag_id']) && !empty($params['tag_id'])) {
            $select->where('tag_id = ?', $params['tag_id']);
        }
